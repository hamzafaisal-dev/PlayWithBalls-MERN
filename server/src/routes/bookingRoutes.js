...
bookingRouter.post('/cities/:cityID/areas/:areaID/grounds/:groundID/bookings', verifyAccessToken, createBooking);
...
bookingRouter.get('/cities/:cityID/areas/:areaID/grounds/:groundID/bookings', verifyAccessToken, getAllBookings)
